...
The Verge Windows Phone dies today The Verge Microsoft is killing off Windows Phone 8.1 support today, more than three years after the company first introduced the update. The end of support marks an end to the Windows Phone era, and the millions of devices still running the operating system. Windows Phone 'Died' Today, Windows 10 Mobile Charitably on Life Support ExtremeTech Microsoft officially ends support for Windows Phone Engadget Microsoft says goodbye to Windows Phone Business Insider AppleInsider (press release) (blog) - Windows IT Pro - CNET - SuperSite for Windows all 203 news articles »
