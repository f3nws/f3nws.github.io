...
The Verge Windows Phone dies today The Verge Microsoft is killing off Windows Phone 8.1 support today, more than three years after the company first introduced the update. The end of support marks an end to the Windows Phone era, and the millions of devices still running the operating system. What happens when an Office 365 subscription expires? Computerworld Microsoft Is Finally Killing Windows Phone Motley Fool Windows Phone 'Died' Today, Windows 10 Mobile Charitably on Life Support ExtremeTech AppleInsider (press release) (blog) - Business Insider - eWeek - Redmondmag.com all 214 news articles »
