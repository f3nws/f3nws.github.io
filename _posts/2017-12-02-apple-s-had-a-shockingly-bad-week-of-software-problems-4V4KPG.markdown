...
The Verge Apple's had a shockingly bad week of software problems The Verge As the week draws to a close, it's definitely been a long one for Apple's software engineers. The nightmare started on Tuesday, after a Twitter user disclosed a critical security vulnerability for macOS High Sierra that allowed anyone with physical ... Apple software sees disastrous, embarrassing week with iOS springboard crash, macOS root user security flaw AppleInsider (press release) (blog) Apple Releases Major iOS 11.2 Update: What Features Are Included? Forbes iOS 11.2 is here with support for Apple Pay Cash, faster wireless charging, and more BGR ZDNet - TechCrunch - Gizmodo - Macworld all 173 news articles »


Full story on F3News: [Apple's had a shockingly bad week of software problems](http://www.f3nws.com/n/4V4KPG)

> Posted on: Saturday, December 2, 2017 1:48:44 PM
