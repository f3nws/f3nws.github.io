...
The Verge Microsoft's next mobile strategy is to make iOS and Android better The Verge Microsoft hasn't had a great time with mobile. While we can debate whether or not Windows Phone is finally dead, Microsoft is certainly ready to move on. After missing the mobile boat, Microsoft is now trying to sneak onto iOS and Android devices like ... Microsoft reaches beyond Windows with Timeline and Pick Up Where I Left Off Ars Technica Microsoft's design rules push Windows 'beyond mere rectangles' Engadget Microsoft makes Windows play nice with Android and iPhone CNET PCWorld - ZDNet - Washington Post - Redmondmag.com all 1,114 news articles »
