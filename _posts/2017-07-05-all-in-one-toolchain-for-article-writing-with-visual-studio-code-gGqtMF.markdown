...
Visual Studio Code extension augments existing Markdown extensions to form all in one toolchain offering convenient editor, rendered document viewer, spell checker and converter to HTML, per CodeProject article submission requirements
