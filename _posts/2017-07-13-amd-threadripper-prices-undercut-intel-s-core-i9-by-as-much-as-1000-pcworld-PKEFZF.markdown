...
PCWorld AMD Threadripper prices undercut Intel's Core i9 by as much as $1000 PCWorld AMD has revealed the prices for some of its Threadripper CPUs, using the same effective strategy that it executed for its mainstream Ryzen chips: set eye-popping discounts compared to Intel's own Core i9 family, and probably earlier release dates, too. AMD Threadripper 1920X and 1950X CPU Details: 12/16 Cores, 4 GHz Turbo, $799 and $999 AnandTech 2 Risks Intel Investors Shouldn't Ignore Motley Fool AMD Announces Ryzen Threadripper, Challenges Intel With 12C/16X For $799 and $999 Tom's Hardware Ars Technica - VentureBeat - Digital Trends - The Verge all 63 news articles »
